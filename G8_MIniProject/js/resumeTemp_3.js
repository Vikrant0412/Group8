const container3 = document.querySelector('.rt3');
...
const renderPosts = async () => {
    ...
    const template = `    <h2 class="text-center">Template 3</h2>
      ...
      <div class="container">
        <div id="header">
          <div>
            <h4 id="nameT"></h4>
            <!-- <p id="underline"></p> -->
            <!-- <h5>android and web devloper</h5> -->
          </div>
        </div>
        <div class="row">
          <div class="col">
            <h4 id="prs">Personal Information</h4>
            <div id="personal">
              <p><b>Address:</b></p>
              <p id="addressT"></p>
              <p><b>State:</b></p>
        ...
        <div class="row">
          <div class="col-12">
            <h4 id="prs">Educational Details</h4>
        ...
        <center>
          <div id="btn">
            <button
              ...
              onclick="printForm(); clickCounter3()"
            >
              Download
            </button>
          </div>
