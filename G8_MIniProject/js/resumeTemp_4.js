const container4 = document.querySelector('.rt4');
...
const renderPosts = async () => {
    ...
    const template = `<h2 class="text-center">Resumé</h2>
    <div class="container commonFont" id="showInformation">
      <div class="row">
        ...
        <div class="col-4">
          ...
          <div class="form-group my-3">
            <label for="postgraduationField"
              >Post Graduation(if applicable)</label
            >
    ...
    <div id="show">
      <div class="container resume">
        ...
        <div class="row my-5">
          <div class="col-12">
            <h3 class="p-3 mb-2 bg-secondary text-white">Career Objective :</h3>
            <p id="objectiveT">-</p>
          </div>
        </div>

        <div class="row my-5">
          <h3 class="p-3 mb-2 bg-secondary text-white">Personal Profile</h3>
          <div class="col-md-6">
        ...
        <div class="row my-5">
          <h3 class="p-3 mb-2 bg-secondary text-white">
      ...
      <center>
        <div id="btn">
          <button
            ...
            onclick="printForm(); clickCounter4()"
          >
            Download
          </button>
        </div>
