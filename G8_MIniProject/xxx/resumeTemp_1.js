const container = document.querySelector('.vicky');
...
const renderPosts = async () => {
    ...
    const template1 = `<h1>Hello${users[0].id}</h1>`;

 

    const template = ` <h2 class="text-center">Information</h2>
    <div class="container" id="showInformation">
      <div class="row">
        ...
        <div class="col-4">
          ...
          <div class="form-group my-3">
            ...
            <input type="number" class="form-control" id="tenthField" />
            <div id="tenthErrorDiv"></div>
          </div>

          <div class="form-group my-3">
            <label for="twelthField">12th</label>
            <input type="number" class="form-control" id="twelthField" />
            <div id="twelthErrorDiv"></div>
          </div>

          <div class="form-group my-3">
            <label for="graduationField">Graduation</label>
            <input type="number" class="form-control" id="graduationField" />
      ...
      <div class="container text-center my-3">
        <button onclick="generateCV()" class="btn btn-primary btn-lg" id="print-btn">
          Generate CV
        </button>
      </div>
    </div>
    ...
    <h1 class="text-center commonFont"></h1>

    <div id="show">
      <div class="container resume commonFont">
        <div class="row my-3">
          <div class="col-md-6">
            <h6 id="nameT"></h6>
            <p><b>Address:</b></p>
        ...
        <div class="row my-5">
          <div class="col-12">
            <h3 style="text-decoration: underline">Career Objective :</h3>
            <p id="objectiveT">-</p>
          </div>
        </div>
        ...
        <div class="row my-5">
          <h3 style="text-decoration: underline">Personal Profile</h3>
          <div class="col-md-6">
      ...
      <center>
        <div id="btn">
          <button
            ...
            onclick="printForm(); clickCounter1()"
          >
            Download
          </button>
        </div>
